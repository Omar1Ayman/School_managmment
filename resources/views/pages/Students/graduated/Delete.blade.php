    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('Graduated.destroy' , 'delete')}}" method="post">
                    @csrf
                    @method("DELETE")
                    <input type="hidden" name="student_id" value="{{$student->id}}">

                    <h5 style="font-family: 'Cairo', sans-serif;">{{trans('Students_trans.Deleted_Student_tilte')}} {{ $student->name }}</h5>
