                                        ...
                                        <table class="table center-aligned-table mb-0 table table-hover"
                                            ...
                                            @foreach($Student->images as $attachment)
                                                <tr style='text-align:center;vertical-align:middle'>
                                                    ...
                                                    <td colspan="2">
                                                        <a href="{{url('open_attachment')}}/{{ $attachment->imageable->name }}/{{$attachment->filename}}" target="_blank" class="btn btn-outline-success btn-sm" role="button" aria-pressed="true"><i class="far fa-eye"></i></a>
