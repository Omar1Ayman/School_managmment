                                                            ...
                                                            <table class="table center-aligned-table mb-0">
                                                                ...
                                                                @foreach ($Grade->sections as $list_Sections)
                                                                    <tr>
                                                                        ...
                                                                        <td>{{ $list_Sections->class->name }}
                                                                        </td>
                                                                        <td>
                                                                            @if ($list_Sections->state === 1)
                                                                                <label
                                                                                    class="badge badge-success">{{ trans('Sections_trans.Status_Section_AC') }}</label>
                                                                            @else
                                                                                <label
...
{{-- <script>
    $(document).ready(function(){
        $('select[name="Grade_id"]').on('change' , function(){
            var Grade_id = $(this).val();
            $if(Grade_id){ // start if
                $.ajax({ //start ajax

                    url: "{{ URL::to('classes') }}/"+Grade_id,
                    type : "GET",
                    dataType : "json",
                    success : function(data){//start func
                        $('select[name="Class_id"]').empty();
                        $.each(data , function(key , val){//start loop
                            $('select[name="Class_id"]').append('<option value="' + key + '">' + val + '</option>');
