                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-row">
                                <div class="form-group col">
                                    ...
                                    <select class="custom-select my-1 mr-sm-2" name="spec_id">
                            ...
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    <div class='input-group date'>
                                        <input class="form-control" type="text"  id="datepicker-action"  value="{{$Teachers->join_date}}" name="join_date" data-date-format="yyyy-mm-dd"  required>
                                    </div>
                                    @error('join_date')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
