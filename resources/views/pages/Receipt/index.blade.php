...
@section('title')
     {{ trans("main_translate.Catch_Receipts") }}
@stop
@endsection
@section('page-header')
<!-- breadcrumb -->
...
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0"> {{ trans("main_translate.Catch_Receipts") }}</h4>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                <li class="breadcrumb-item"><a href="{{ url("/") }}" class="default-color">{{ trans("main_translate.home") }}</a></li>
                <li class="breadcrumb-item active"> {{ trans("main_translate.Catch_Receipts") }}</li>
            </ol>
        </div>
    </div>
</div>
